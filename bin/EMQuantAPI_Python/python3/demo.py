...
try:
    ...
    # csd使用范例
    data = c.csd("300059.SZ", "open,close", "2016-07-01", "2016-07-06", "RowIndex=1,period=1,adjustflag=1,curtype=1,pricetype=1,year=2016,Ispandas=0")
    ...
    #实时行情订阅使用范例
    data = c.csq('300059.SZ', 'TIME,Now,Volume','Pushtype=2',csqCallback)
    if(data.ErrorCode != 0):
